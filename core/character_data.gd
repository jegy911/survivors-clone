...
const CHARACTERS = [
	...
	# --- Yeni roller (sıra sonu — kayıtlı karakter indekslerini kaydırmamak için) ---
	{
		"id": "sigil_warden",
		"name": "Mühür Ustası",
		"description": "Çöküşten kalma rün mühürleri.\nAltıgön Mühür + Rün Tılsımı; evrim: Bağlayıcı Halka.",
		"color": "#48C9B0",
	...
	},
	{
		"id": "grav_binder",
		"name": "Eğim Bağlayıcı",
		"description": "Harabe çekim alanları ustası.\nÇekim Çapası + Rezonans Taşı; evrim: Uçurum Merceği.",
		"color": "#AF7AC5",
	...
	},
	{
		"id": "ironclad",
		"name": "Tam Zırhlı",
		"description": "Ön hat siperi.\nKale Gürzü + Rampa Plakası; evrim: Hisar Zinciri.",
		"color": "#7F8C8D",
	...
	},
	{
		"id": "linebreaker",
		"name": "Hat Kıran",
		"description": "Kalkan hamlesiyle hat yarar.\nKalkan Hamlesi + Demir Siper; evrim: Kale Sur Koşusu.",
		"color": "#B7950B",
